var hoursSleptVsPassedBuilds = function() {
    var margin = {
        top: 20,
        right: 80,
        bottom: 30,
    ...
    var svg = d3.select("#hours-slept-vs-passed-builds").append("svg")
        .attr("width", width + margin.left + margin.right)
        .attr("height", height + margin.top + margin.bottom)
        .append("g")
        .attr("transform", "translate(" + margin.left + "," + margin.top + ")");

    d3.tsv("js/hours-slept-vs-passed-builds.tsv", function(error, data) {
